...
/**
 * The switcher's list and `locales_config.xml` are the same claim written twice (ADR-0013), and
...
class AppLanguageTest {
    ...
    fun `english is the base language and is always offered`() {
        // ADR-0013: English is the fallback for every unmatched locale, so it is the one entry that

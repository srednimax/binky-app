 ...
 *
 * Nav3 hands every back-stack entry its own `ViewModelStoreOwner` (see `entryDecorators` in
 ...
 * every factory here reads that key to reach `AppContainer`. Without it `this[APPLICATION_KEY]`
 * is null and the cast in the initializer throws the moment the screen opens.
 *

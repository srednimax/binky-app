 ...
 * function is an alarm clock or a calendar, and this app's core function is a rabbit's weight chart.
 ...
 *
 * Read fresh at every use, never cached. The owner can revoke it from system settings while the app
 * is in the background, and on Android 14+ revoking it also cancels every pending exact alarm this
 * app placed (ADR-0025's "ways to lose it").
 */
...
/**
 * Opens the system screen where the owner grants exact alarms, and that is the end of it.
 *
